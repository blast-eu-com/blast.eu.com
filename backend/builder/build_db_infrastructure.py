...
__CREATE_INDEX_TEMPLATE = """curl -s -XPUT -H \"Content-Type: Application/Json\" """ + __ES_ADDR + """/_template/infrastructure -d@""" + __DATAMODEL_REALM_FILE
__ES_PROVISION_DEFAULT = """curl -s -XPOST -H \"Content-Type: Application/Json\" """ + __ES_ADDR + """/infrastructure/_doc -d '{
    "name": \"""" + __REALM + """\",
