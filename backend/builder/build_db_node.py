...
__DATAMODEL_NODE_FILE = os.path.join(_DATAMODEL_DIR, 'node.template.mapping')
__INDEX_NAME = "blast_obj_node"
__INDEX_TEMPLATE_DATA = json.load(open(__DATAMODEL_NODE_FILE, 'r'))
