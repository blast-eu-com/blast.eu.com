...
__CREATE_INDEX_TEMPLATE = """curl -s -XPUT -H \"Content-Type: Application/Json\" """ + __ES_ADDR + """/_template/scenario -d@""" + __DATAMODEL_REALM_FILE
__CREATE_INDEX = """curl -s -XPUT """ + __ES_ADDR + """/scenario"""
