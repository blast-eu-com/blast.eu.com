...
__DATAMODEL_REQUEST_FILE = os.path.join(_DATAMODEL_DIR, 'request.template.mapping')
__INDEX_NAME = "blast_request"
__INDEX_TEMPLATE_DATA = json.load(open(__DATAMODEL_REQUEST_FILE, "r"))
