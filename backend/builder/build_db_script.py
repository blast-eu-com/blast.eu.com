...
__DATAMODEL_SCRIPT_FILE = os.path.join(_DATAMODEL_DIR, 'script.template.mapping')
__INDEX_NAME = "blast_obj_script"
__INDEX_TEMPLATE_DATA = json.load(open(__DATAMODEL_SCRIPT_FILE, "r"))
