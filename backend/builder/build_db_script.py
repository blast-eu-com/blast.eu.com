...
__CREATE_INDEX_TEMPLATE = """curl -s -XPUT -H \"Content-Type: Application/Json\" """ + __ES_ADDR + """/_template/blast_obj_script -d@""" + __DATAMODEL_REALM_FILE
__CREATE_INDEX = """curl -s -XPUT """ + __ES_ADDR + """/blast_obj_script"""
__ES_PROVISION_DEFAULT = """curl -s -XPOST -H \"Content-Type: Application/Json\" """ + __ES_ADDR + """/blast_obj_script/_doc -d '{}'"""
