...
var SchedulerSelectAndManage = class {
    ...
    schedulerRunCoreData = (schedulerData) => {
        ...
        for (let i=firstRec; i<lastRec; i++) {
            ...
            <td width="512px"><a href="/html/scheduler-details.html?scheduler_name=` + schedulerDataFiltered[i]["_source"]["name"] + `&scheduler_id=` + schedulerDataFiltered[i]["_id"] + `">` + schedulerDataFiltered[i]["_source"]["name"] + `</a></td>
