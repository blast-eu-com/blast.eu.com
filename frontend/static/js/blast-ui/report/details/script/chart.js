...
const ReportScriptChart = class {

    constructor() {
        this._pn = undefined
        this._reportData = undefined
        this._frame = `<canvas class="mb-3" id="reportScriptCanvas" width="400" height="100"></canvas>`
        this._chart
    }
...
export default ReportScriptChart